...
namespace Business.Concrete
{
    public class UniversityManager: IUniversityService
    {
        ...
        {
            return new SuccessDataResult<List<University>>(_universityDal.GetAll().OrderBy(s => s.UniversityName).ToList(), Messages.SuccessListed);
        }

        [SecuredOperation("admin,user")]
        public IDataResult<List<University>> GetDeletedAll()
        {
            return new SuccessDataResult<List<University>>(_universityDal.GetDeletedAll().OrderBy(s => s.UniversityName).ToList(), Messages.SuccessListed);
        }
        [SecuredOperation("admin,user")]
        ...
        {
            return new SuccessDataResult<List<UniversityDTO>>(_universityDal.GetAllDTO().OrderBy(s => s.UniversityName).ToList(), Messages.SuccessListed);
        }
        [SecuredOperation("admin,user")]
        public IDataResult<List<UniversityDTO>> GetDeletedAllDTO()
        {
            return new SuccessDataResult<List<UniversityDTO>>(_universityDal.GetDeletedAllDTO().OrderBy(s => s.UniversityName).ToList(), Messages.SuccessListed);
        }
        ...
        {
            var result = _universityDal.GetAll(c => c.WebAddress.ToLower() == entityName.ToLower() && c.WebAddress != "-").Any();
        ...
        {
            var result = _universityDal.GetAll(c => c.WebNewsAddress.ToLower() == entityName.ToLower() && c.WebNewsAddress != "-").Any();
        ...
        {
            var result = _universityDal.GetAll(c => c.YouTubeEmbedAddress.ToLower() == entityName.ToLower() && c.YouTubeEmbedAddress != "-").Any();
        ...
        {
            var result = _universityDal.GetAll(c => c.Address.ToLower() == entityName.ToLower() && c.Address != "-").Any();
        ...
        {
            var result = _universityDal.GetAll(c => c.FacebookAddress.ToLower() == entityName.ToLower() && c.FacebookAddress != "-").Any();
        ...
        {
            var result = _universityDal.GetAll(c => c.InstagramAddress.ToLower() == entityName.ToLower() && c.InstagramAddress != "-").Any();
        ...
        {
            var result = _universityDal.GetAll(c => c.XAddress.ToLower() == entityName.ToLower() && c.XAddress != "-").Any();
        ...
        {
            var result = _universityDal.GetAll(c => c.YouTubeAddress.ToLower() == entityName.ToLower() && c.YouTubeAddress != "-").Any();
