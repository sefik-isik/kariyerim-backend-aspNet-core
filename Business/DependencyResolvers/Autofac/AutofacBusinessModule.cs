...
namespace Business.DependencyResolvers.Autofac
{
    public class AutofacBusinessModule : Module
    {
        protected override void Load(ContainerBuilder builderItem)
        {
            ...
            builderItem.RegisterType<LicenceDegreeManager>().As<ILicenceDegreeService>().SingleInstance();
            ...
            builderItem.RegisterType<DepartmentDetailManager>().As<IDepartmentDetailService>().SingleInstance();
            ...
            builderItem.RegisterType<EfLicenceDegreeDal>().As<ILicenceDegreeDal>().SingleInstance();
            ...
            builderItem.RegisterType<EfDepartmentDetailDal>().As<IDepartmentDetailDal>().SingleInstance();
