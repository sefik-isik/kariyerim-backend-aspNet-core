...
namespace Business.Abstract
{
    public interface ICompanyUserAddressService
    {
        ...
        IDataResult<List<CompanyUserAddress>> GetAll(int UserId);
        IDataResult<CompanyUserAddress> GetById(int companyUserAddressId);
        


        //DTO
        IDataResult<List<CompanyUserAddressDTO>> GetCompanyUserAddressDTO(int userId);
        IDataResult<List<CompanyUserAddressDTO>> GetCompanyUserAddressDeletedDTO(int userId);
    }
}
