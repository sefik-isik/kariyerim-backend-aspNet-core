...
namespace DataAccess.Concrete.EntityFramework
{
    public class EfCompanyUserAdvertDal : EfEntityRepositoryBase<CompanyUserAdvert, KariyerimContext>, ICompanyUserAdvertDal
    {
        ...
        public async Task<List<CompanyUserAdvertDTO>> GetAllByCompanyUserId(string companyUserId)
        {
            using (KariyerimContext context = new KariyerimContext())
            {
                var result = from companyUserAdvert in context.CompanyUserAdverts
                             ...
                             where users.Code == UserCodes.CompanyUserCode && companyUserAdvert.CompanyUserId == companyUserId && companyUserAdvert.DeletedDate == null && users.DeletedDate == null && companyUsers.DeletedDate == null && workAreas.DeletedDate == null
                             && workingMethods.DeletedDate == null && experiences.DeletedDate == null
                             && companyUserDepartments.DeletedDate == null && licenseDegrees.DeletedDate == null
                             && countries.DeletedDate == null && cities.DeletedDate == null && regions.DeletedDate == null && sectors.DeletedDate == null
        ...
        public async Task<List<CompanyUserAdvertDTO>> GetByAdvertId(string advertId)
        {
            using (KariyerimContext context = new KariyerimContext())
            {
                var result = from companyUserAdvert in context.CompanyUserAdverts
                             ...
                             where users.Code == UserCodes.CompanyUserCode && companyUserAdvert.Id == advertId && companyUserAdvert.DeletedDate == null && users.DeletedDate == null && companyUsers.DeletedDate == null && workAreas.DeletedDate == null
                             && workingMethods.DeletedDate == null && experiences.DeletedDate == null
                             && companyUserDepartments.DeletedDate == null && licenseDegrees.DeletedDate == null
                             && countries.DeletedDate == null && cities.DeletedDate == null && regions.DeletedDate == null && sectors.DeletedDate == null
