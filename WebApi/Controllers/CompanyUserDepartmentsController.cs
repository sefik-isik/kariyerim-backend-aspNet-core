...
namespace WebAPI.Controllers
{
    ...
    public class CompanyUserDepartmentsController : ControllerBase
    {
        ...
        {
            var result = _companyUserDepartmentService.GetAll(id);
            return result.IsSuccess ? Ok(result) : BadRequest(result);
        }
        ...
        {
            var result = _companyUserDepartmentService.GetDeletedAll(id);
            return result.IsSuccess ? Ok(result) : BadRequest(result);
        }
        ...
        {
            var result = _companyUserDepartmentService.GetAllDTO(id);
            return result.IsSuccess ? Ok(result) : BadRequest(result);
        }
        ...
        {
            var result = _companyUserDepartmentService.GetAllDeletedDTO(id);
            return result.IsSuccess ? Ok(result) : BadRequest(result);
        }
